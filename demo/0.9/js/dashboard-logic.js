$(function() {
    ...
    $.monitor_dataurl = "{0}/json/fetchdata.json".format(window.location.href.replace(/^(.*)\/[^\/]*$/, "$1"));
    //$.monitor_dataurl = "{0}/tmp.json".format(window.location.href.replace(/^(.*)\/[^\/]*$/, "$1"));
    $.personnel_url = "{0}/json/get_dashboard_data.json".format(window.location.href.replace(/^(.*)\/[^\/]*$/, "$1"));   
    $.getconfig_url = "{0}/json/expose_configuration.json".format(window.location.href.replace(/^(.*)\/[^\/]*$/, "$1")); 
    $.lastok_url = "{0}/json/get_last_state.json".format(window.location.href.replace(/^(.*)\/[^\/]*$/, "$1")); 
    $.lastok_chart_url = "{0}/json/get_last_state_history.json".format(window.location.href.replace(/^(.*)\/[^\/]*$/, "$1"));     
    $.user_msg_url = "{0}/json/get_messages.json".format(window.location.href.replace(/^(.*)\/[^\/]*$/, "$1")); 
